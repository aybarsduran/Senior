...
namespace UnityEngine
{
    ...
    public class ReorderableListExposedAttribute : ReorderableListAttribute
    {
        ...
        public ReorderableListExposedAttribute(ListStyle style = ListStyle.Round, string childLabel = null, bool fixedSize = false, bool draggable = true)
            : base(style, childLabel, fixedSize, draggable) { }
    }
}